...
docx_handler.py
────────────────
Handles DOCX contract documents. For now this is a stub entrypoint
so the pipeline import works. Add Azure CU or format parsing later.
"""
...
def handle_docx(
    ...
    """Process a DOCX file and return extraction results."""
    log.warning("[DOCX Handler] DOCX support is not implemented yet. Returning stub empty output.")
    return [{
        "_source": "docx_stub",
